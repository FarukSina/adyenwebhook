  ...
  <div className="main-container">
    <div className="info">
      ...
      <p>
        ...
        <a href="https://docs.adyen.com/payment-methods#add-payment-methods-to-your-account">the documentation</a> to add missing payment
        methods.
      </p>
      <p>
        To learn more about client-side integration solutions, check out <a href="https://docs.adyen.com/checkout">Online payments.</a>
      </p>
    </div>
    ...
    <div className="mt-5">
      <Link to="/cancel" className="button text-light mb-2">
        Cancel and Refund a payment
      </Link>
      <Link to="/capture" className="button text-light">
        Capture a payment
      </Link>
    </div>
  </div>
